...
object PatternMatching extends App {
  ...
  val greeting = bob match {
    case Person(n, a) if a < 21 => s"Hi my name is ${n} and I am cannot drink in US"
  ...
  * 3. type of the pattern matching expression -> unified type of all the types in all cases
